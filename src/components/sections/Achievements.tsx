...
// Remove BrainCircuit if not available in lucide-react
const iconMap: { [key: string]: React.ElementType } = {
  Code: Code,
  Award: Award,
  Users: Users,
  // 'BrainCircuit': BrainCircuit, // Remove or replace with a valid icon
};
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {achievements.map((achievement, index) => {
            const Icon = iconMap[achievement.icon] || Award; // fallback to Award
            return (
